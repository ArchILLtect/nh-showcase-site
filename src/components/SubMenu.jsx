 ...
 * Description: A menu component for displaying sub-menu items.
 * 
 * Props:
 ...
 * - useRef: A React hook for creating a mutable ref object.
 * - NavLink: A React Router component for navigation links.
 * - useLocation: A React Router hook for accessing the current location.
    ...
    <li className="relative" ref={menuRef}>
      ...
      {open && topic === "Projects" && (
        <div
          ...
          className="absolute left-0 mt-2.5 w-56 bg-white dark:bg-gray-800 rounded-md shadow-lg ring-1 ring-black/5 z-50"
        >
          <NavLink to="/projects" role="menuitem" className={({ isActive }) => submenuItem(isActive)}>
            My Projects
          </NavLink>
          <NavLink to="/future-projects" role="menuitem" className={({ isActive }) => submenuItem(isActive)}>
            Future Projects
          </NavLink>
        </div>
      )}
