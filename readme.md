...
- **docs/**
  - **dev/**
  - [AUTH_OVERVIEW.md](docs/AUTH_OVERVIEW.md)
  - [MOBILE_NAVBAR_QA_CHECKLIST.md](docs/MOBILE_NAVBAR_QA_CHECKLIST.md)
- **lambda-functions/**
  ...
  - **showcaseVerifyEmail/**
  - [README.md](lambda-functions/README.md)
- **public/**
  - **data/**
  - **icons/**
  - **images/**
...
- **scripts/**
  - [export-auth-config-baseline.ps1](scripts/export-auth-config-baseline.ps1)
  - [package-lambda.ps1](scripts/package-lambda.ps1)
- **src/**
  - **admin/**
  - **api/**
  - **components/**
