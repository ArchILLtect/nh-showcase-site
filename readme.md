...
- Account-scoped recovery playbook (email reuse allowed): [docs/ACCOUNT_RECOVERY_ACCOUNT_SCOPED_PLAYBOOK.md](docs/ACCOUNT_RECOVERY_ACCOUNT_SCOPED_PLAYBOOK.md)
...
- Registration P1 email identity policy (reuse allowed): [docs/REGISTRATION_P1_EMAIL_UNIQUENESS_STRATEGY.md](docs/REGISTRATION_P1_EMAIL_UNIQUENESS_STRATEGY.md)
- Registration P1 email policy alignment playbook: [docs/REGISTRATION_P1_EMAIL_UNIQUENESS_IMPLEMENTATION_PLAYBOOK.md](docs/REGISTRATION_P1_EMAIL_UNIQUENESS_IMPLEMENTATION_PLAYBOOK.md)
